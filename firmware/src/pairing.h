...
const char *pairing_mac(void);
const char *pairing_last_event(void);
const char *pairing_adv_layout(void);
const char *pairing_service_uuid(void);
const char *pairing_peer(void);
const char *pairing_last_rx(void);
const char *pairing_hint(void);
const char *pairing_event_log(void);
uint16_t pairing_mtu(void);
uint32_t pairing_connect_count(void);
uint32_t pairing_write_count(void);
uint32_t pairing_read_count(void);
